...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
      <div class="content-wrapper py-5" style="flex: 0.6 !important;">
        ...
        <div class="text-white px-5 fw-bold font-tituview">TITULO DE CAPACITACIÓN</div>
        <div class="d-flex mb-3">
            <div class="d-flex flex-row  px-5   fw-light text-plo">
                <div class="p-2"> <span class="mdi mdi-calendar-month-outline"></span> Fecha de Registro 2024-07-08 </div>
                <div class="p-2"> <span class="mdi mdi-account-school"></span> Estudiantes: 40</div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="px-2 w-100">
                                <label for="smallInput" class="form-label ">Descripcion:</label>
                                <input id="smallInput" class="form-control form-control-sm bg-input" type="text"
                                    placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-row mb-3 justify-content-between">
                            ...
                            <div class="px-2 w-50 d-flex flex-row justify-content-end">
                                ...
                                <button type="button" class="btn btn-cancelar "
                                    data-bs-dismiss="modal">IMPORTAR</button>
                                <button type="button" class="btn btn-guardar ">GUARDAR</button>
                            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><i class="ri-suitcase-2-line ri-22px text-danger me-4"></i><span
                                                        class="fw-medium">
                                                        <font style="vertical-align: inherit;">
                                                            <font style="vertical-align: inherit;">Proyecto Tours</font>
                                                        </font>
                                                    </span></td>
                                                <td>
                                                    <font style="vertical-align: inherit;">
                                            ...
                                            <tr>
                                                <td><i class="ri-leaf-fill ri-22px text-success me-4"></i><span
                                                        class="fw-medium">
                                                        <font style="vertical-align: inherit;">
                                                            <font style="vertical-align: inherit;">Proyecto de invernadero
                                                            </font>
                                                        </font>
                                                    </span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><i class="ri-bank-fill ri-22px text-primary me-4"></i><span
                                                        class="fw-medium">
                                                        <font style="vertical-align: inherit;">
                                                            <font style="vertical-align: inherit;">Proyecto bancario</font>
                                                        </font>
                                                    </span></td>
                                                <td>
                                                    <font style="vertical-align: inherit;">
        ...
        <div class="  style-course text-white align-items-start">
            <div class="d-flex ">
                <div class="d-flex flex-column align-self-center px-2 w-50">

                    <div class=" sub-text">CÓDIGO</div>
                    <div class=" nombr-cap">Nombre del Estudiante</div>

                </div>

                <div class="ms-auto p-2 d-flex flex-row align-self-center btn-group">
                    <div class="p-2"> <button type="button" class="btn btn-primary"><span
                                class="mdi mdi-file-pdf-box text-white size-icon"></span></button></div>
                    <div class="p-2"> <button type="button" class="btn btn-primary"><span
                                class="mdi mdi-email-arrow-right"></span></button> </a>
                    </div>
                </div>
