    ...
    <div class="email-wrapper">
        <div class="email-content">
            ...
            <div class="email-header">
                <img src="{{ asset('mails/images2/img/encabezado-cip.png') }}" alt="Encabezado del Correo" />
          ...
          ;">
                  ...
                  text-align: left !important; ">Certificado de
                            Aprobración de
                            Diplomado <br />
                            por el Colegio de Ingenieros del Perú</h1>
                    </div>
                    <div style="display: flex;     margin-left: auto;"> <img class="img-cip"
                            src="{{ asset('mails/images2/img/cip.png') }}" alt /> </div>
            ...
            <div class="email-body text-cont">
                <div style="margin: 0 20px">
                    ...
                    <p>Espero que celebres este éxito de la manera que mereces. Te animo
                        a seguir persiguiendo tus metas con la misma pasión y
                        determinación que hasta ahora. Estoy seguro/a de que tu futuro
                        estará lleno de éxitos aún mayores.</p>
                    <p></p>
                ...
                position: relative;
              "
                        src="{{ asset('mails/images2/img/idelecip-diplo.png') }}" alt="Imagen de servicio" />
                    @php
                ...
                <img src="{{ asset('mails/images2/img/director-cip.png') }}" alt="Imagen de servicio" />
