...
<body>
    <section class="container-fluid d-flex justify-content-center">
        <div class="d-flex justify-content-start">
            <div>
                <img class="fondo-dozer" src="{{ asset('mails/img/fondo-diplomado-cip.png') }}" alt="..." />
            </div>
        </div>
        ...
        <div class="text-black position-absolute pt-50 d-flex flex-column mb-3 contenido-cip justify-content-center">
            ...
            <div class="text-center titulo-cip-diplo">
                <h1 class="fw-bold font-titulo">
                    CERTIFICADO DE DIPLOMADO DE INSTITUTO DOZER
                </h1>
            </div>
            ...
            <div class="contenido-texto text-center">
                ...
                <div>
                    <button class="btn btn-descarga-cip" type="submit">
                        Descargar
                    </button>
                </div>
            </div>
