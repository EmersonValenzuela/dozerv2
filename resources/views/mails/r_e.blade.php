        ...
        <div class="email-content">
            ...
            <div class="email-header">
                ...
                <h1 class="text-titulo">
                    Certificado de Excelencia Académica por Instituto Dozer
                </h1>
            </div>
            ...
            <div class="email-body text-cont">
                <div style="margin: 0 20px">
                    ...
                    <p>
                        ...
                        dedicación, esfuerzo y determinación han sido recompensados y te
                        has convertido en un ejemplo a seguir para todos nosotros.
                    </p>
                    <p>
                        Tu talento y habilidades destacan en todo lo que haces. No solo
                        has demostrado ser una persona comprometida y trabajadora, sino
                        que también has logrado superarte a ti mismo/a una y otra vez.
                        Este logro es un testimonio de tu capacidad para enfrentar
                    ...
                    <p>
                        ...
                        pasión por lo que haces son inspiradoras y contagian a aquellos
                        que te rodean. Eres un líder nato y una fuente constante de
                        motivación para todos nosotros.
                    </p>
                    <br>
                    <img style="
                ...
                position: relative;
              "
                        src="{{ asset('mails/images2/img/exc.png') }}" alt="Imagen de servicio" />
