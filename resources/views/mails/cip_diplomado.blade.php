...
<html lang="en">
  ...
  <body>
        ...
        <div class="row">
          ...
          >
            <div class="p-2 text-cip-titulo">
              Certificado de Aprobración de Diplomado <br />
      ...
      <div class="row">
        ...
        <div class="text-cont">
          ...
          <p>
            ...
            ser una persona comprometida y capaz de enfrentar cualquier reto que
            se te presente. Este logro es un reflejo de tu dedicación y
    ...
    <section class="section-final-cip">
      <div class="d-flex flex-row mb-3 d-flex align-items-center seccion-dicip">
        <div class="">
