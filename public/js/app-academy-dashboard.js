...
!(function () {
  ...
  const o = document.querySelector("#horizontalBarChart"),
    n = {
      ...
      tooltip: {
        ...
        custom: function ({ series: e, seriesIndex: a, dataPointIndex: t }) {
  ...
  r.length &&
    ((l = r.DataTable({
      ...
      columnDefs: [
            ...
            return (
              (t = n
                ...
                : '<span class="avatar-initial rounded-circle bg-label-' +
                  ...
                  '">' +
                  (n = (
                    ((n = t.user.match(/\b\w/g) || []).shift() || "") +
                    (n.pop() || "")
                  ).toUpperCase()) +
                  "</span>"),
              '<div class="d-flex align-items-center"><span class="me-3">' +
                d[s] +
                '</span><div><a href="app-academy-course-details.html"><span class="text-heading mb-2 text-wrap fw-medium">' +
                i +
                '</span></a><div class="d-flex align-items-center mt-1"><div class="avatar-wrapper me-2"><div class="avatar avatar-xs">' +
                t +
                '</div></div><span class="text-nowrap text-heading">' +
                o +
                "</span></div></div></div>"
            );
          },
        ...
        },
        {
          ...
          render: function (e, a, t, r) {
            var s = t.status;
            return (
              '<div class="d-flex align-items-center gap-3"><h6 class="mb-0">' +
              s +
        ...
        },
        {
          ...
          render: function (e, a, t, r) {
            return (
              '<div class="d-flex align-items-center justify-content-between"><div class="w-px-50 d-flex align-items-center"><i class="mdi mdi-account-outline mdi-24px me-2 text-primary"></i>' +
              t.user_number +
              'k</div><div class="w-px-50 d-flex align-items-center"><i class="mdi mdi-laptop mdi-24px me-2 text-info" ></i>' +
              t.note +
              '</div><div class="w-px-50 d-flex align-items-center"><i class="mdi mdi-video-outline mdi-24px me-2 text-danger scaleX-n1-rtl" ></i>' +
              t.view +
              "</div></div>"
            );
          },
      ...
      order: [[2, "desc"]],
      dom: '<"card-header pt-sm-0 pb-0 flex-column flex-sm-row"<"head-label text-center">f>t<"row mx-4"<"col-sm-6 col-12 text-center text-xl-start pb-2 pb-xl-0 px-0"i><"col-sm-6 col-12 d-flex justify-content-center justify-content-xl-end px-0"p>>',
      lengthMenu: [5],
      language: {
        sLengthMenu: "_MENU_",
        search: "",
