...
!(function () {
  ...
  function c(t) {
    t &&
      null !== t._element &&
      (o &&
        (o.querySelector("i.mdi").classList.remove(a),
        DOMTokenList.prototype.remove.apply(o.classList, i)),
      e &&
        (e.querySelector("i.mdi").classList.remove(a), e.classList.remove(n)),
      t.dispose());
  }
  t &&
    (t.onclick = function () {
      r && c(r),
        ...
        e.querySelector("i.mdi").classList.add(a),
        e.classList.add(n),
        (r = new bootstrap.Toast(e)).show();
    }),
    s &&
      (s.onclick = function () {
        l && c(l),
          ...
          o.querySelector("i.mdi").classList.add(a),
          DOMTokenList.prototype.add.apply(o.classList, i),
          (l = new bootstrap.Toast(o)).show();
      });
})(),
  $(function () {
    var k,
      ...
      $("#showtoast").on("click", function () {
        var t = $("#toastTypeGroup input:radio:checked").val(),
          ...
          o =
            ...
            r.val().length &&
              (toastr.options.extendedTimeOut = h ? 0 : parseInt(r.val())),
