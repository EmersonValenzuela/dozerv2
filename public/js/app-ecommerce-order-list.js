    ...
    ((e = n.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (e, t, a, s) {
            var n = a.customer,
              ...
              o = a.avatar;
            return (
              '<div class="d-flex justify-content-start align-items-center user-name"><div class="avatar-wrapper me-3"><div class="avatar avatar-sm">' +
              (o
                ? '<img src="' +
                  assetsPath +
                  "img/avatars/" +
                ...
                : '<span class="avatar-initial rounded-circle bg-label-' +
                  ...
                  "</span>") +
              '</div></div><div class="d-flex flex-column"><a href="pages-profile-user.html" class="text-truncate"><span class="text-heading fw-medium" > ' +
              n +
          ...
          render: function (e, t, a, s) {
            ...
            return (
              ...
              '<div class="d-flex align-items-center text-nowrap"><img src="' +
                ...
                '.png" alt="' +
                n +
                '" class="me-2" width="20"><span><i class="mdi mdi-dots-horizontal"></i>' +
                a +
                "</span></div>"
            );
          },
        },
        {
          ...
          orderable: !1,
          render: function (e, t, a, s) {
            return '<div><button class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></button><div class="dropdown-menu dropdown-menu-end m-0"><a href="app-ecommerce-order-details.html" class="dropdown-item">View</a><a href="javascript:0;" class="dropdown-item delete-record">Delete</a></div></div>';
          },
        },
      ],
      order: [3, "asc"],
      dom: '<"card-header d-flex flex-column flex-md-row align-items-start align-items-md-center"<f><"d-flex align-items-md-center justify-content-md-end mt-2 mt-md-0 ps-1 ms-1 gap-3"l<"dt-action-buttons"B>>>t<"row mx-1"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
