...
!(function () {
  ...
  var a = document.querySelector("#totalRevenue"),
    ...
    s = {
      chart: { height: 114, type: "radialBar", sparkline: { enabled: !0 } },
      plotOptions: {
        radialBar: {
          hollow: { size: "55%" },
          dataLabels: {
      ...
      n.forEach(function (e) {
        var o = config.colors[e.dataset.color],
          ...
          o = {
            ...
            labels: ["Progress"],
            responsive: [
              { breakpoint: 1441, options: { chart: { height: 103 } } },
              { breakpoint: 1400, options: { chart: { height: 100 } } },
              { breakpoint: 1380, options: { chart: { height: 95 } } },
              { breakpoint: 1332, options: { chart: { height: 85 } } },
              { breakpoint: 1265, options: { chart: { height: 75 } } },
              { breakpoint: 1025, options: { chart: { height: 90 } } },
            ],
          };
