...
!(function () {
  ...
  var e = [].slice.call(document.querySelectorAll(".flatpickr-validation")),
    a = $(".selectpicker"),
    a =
      (a.length && (a.selectpicker(), handleBootstrapSelectEvents()),
      e &&
        e.forEach((e) => {
  ...
  document.addEventListener("DOMContentLoaded", function (e) {
    {
      const a = document.getElementById("formValidationExamples"),
        ...
        n = a.querySelector('[name="formValidationLang"]'),
        i = jQuery(a.querySelector('[name="formValidationHobbies"]')),
          ...
          fields: {
            ...
            formValidationConfirmPass: {
              validators: {
                ...
                identical: {
                  compare: function () {
                    return a.querySelector('[name="formValidationPass"]').value;
                  },
      ...
      flatpickr(a.querySelector('[name="formValidationDob"]'), {
        ...
        dateFormat: "Y/m/d",
        onChange: function () {
          l.revalidateField("formValidationDob");
        },
      }),
        t.length &&
          (select2Focus(t),
          ...
          t
            ...
            .on("change.select2", function () {
              l.revalidateField("formValidationSelect2");
            })),
        new Tagify(n),
        n.addEventListener("change", function () {
          l.revalidateField("formValidationLang");
        }),
        o.on("changed.bs.select", function (e, a, t, o) {
          l.revalidateField("formValidationTech");
        }),
        i.on("changed.bs.select", function (e, a, t, o) {
          l.revalidateField("formValidationHobbies");
        });
    }
  });
